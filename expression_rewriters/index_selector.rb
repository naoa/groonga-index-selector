  ...
  module ExpressionRewriters
    class IndexSelector < ExpressionRewriter
      ...
      def check_unsupported_code
        ...
        codes.each do |code|
          case code.op
          when Operator::PREFIX, Operator::NEAR, Operator::NEAR_NO_OFFSET, Operator::NEAR_PHRASE, Operator::ORDERED_NEAR_PHRASE, Operator::NEAR_PHRASE_PRODUCT, Operator::ORDERED_NEAR_PHRASE_PRODUCT, Operator::SIMILAR
            unsupported = true
          when Operator::PUSH
            case code.value
